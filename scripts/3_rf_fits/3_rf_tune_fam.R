# Final Project ----
# step 3: fitting random forest - family and house_fam predictors
# Stat 301-2
...
load(here("recipes/rf_fam_house_rec.rda"))
...
save(rf_tuned_fam, file = here("results/rf_tuned_fam.rda"))
