# Final Project ----
# step 3: fitting k-nearest neighbors - education predictors
# Stat 301-2
...
load(here("recipes/rf_education_rec.rda"))
...
save(knn_tuned_edu, file = here("results/knn_tuned_edu.rda"))
