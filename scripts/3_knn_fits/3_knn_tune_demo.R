# Final Project ----
# step 3: fitting k-nearest neighbors - demographic predictors
# Stat 301-2
...
load(here("recipes/rf_demographics_rec.rda"))
...
knn_wflow <- 
  workflow() |>
  add_model(knn_spec) |>
  add_recipe(rf_demographics_rec)
...
save(knn_tuned_demo, file = here("results/knn_tuned_demo.rda"))
