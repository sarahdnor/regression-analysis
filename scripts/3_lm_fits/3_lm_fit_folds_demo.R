# Final Project ----
# step 3: fitting ordinary linear regression - demographics predictors
# Stat 301-2
...
fit_folds_lm_demo <- fit_resamples(
  lm_wflow, 
...
save(fit_folds_lm_demo, file = here("results/fit_folds_lm_demo.rda"))
